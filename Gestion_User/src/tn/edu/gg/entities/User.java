...
public class User {
    ...
    public User(String firstnameU, String lastnameU, String passwordU, String LoginU, String Role, String adresse) {
     ...
     public User(int id_User, String firstnameU, String lastnameU, String passwordU, String LoginU, String Role, String adresse) {
    ...
    public String toString() {
        return  super.toString() +"User{" + "firstnameU=" + firstnameU + ", lastnameU=" + lastnameU + ", passwordU=" + passwordU + ", loginU=" + loginU + ",Role=" + Role+ ", adresse=" + adresse+"}";
    }
